function Ans = UpDownWind(func, dx, dy, velocity_logic_map)
...
dfuncdy_dw(2:end-1,:) = v_dw_logic(2:end-1, :) .* -(func(2:end-1,:) - func(1:end-2, :)) ./ dy;  %forward  check sign. can be reverse. 

dfuncdx_uw(:,2:end-1) = u_uw_logic(:, 2:end-1) .* (func(:, 2:end-1) - func(:,1:end-2)) ./ dx;   %backward   
dfuncdy_uw(2:end-1,:) = v_uw_logic(2:end-1, :) .* -(func(3:end,:) - func(2:end-1, :)) ./ dy;  %backward check sign. can be reverse. 
