function dimensionalvelocity(solution_matrix, savepath)
...
for j = 1:k
    ...
    for i = 1:m
        EHLCompareU_Dimensional(solution_matrix(j, :, i), savepath_2in)
    end
   ...
   figure(3);
   title("\bf{L = }" + string(solution_matrix(j,1,1).applied_load),"Interpreter","latex")
