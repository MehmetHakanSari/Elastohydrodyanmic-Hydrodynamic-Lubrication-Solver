function [pressure_dic, theta, stress_dic] = VRCavitation(dt, Spatial_Scheme, Temporal_Scheme, solution, mesh, fluid, cavitation_flag)
...
stress_dic =  containers.Map({char("tau_xx"), char("tau_xy"), char("tau_yy")}, {T_xx, T_yy, T_yy});
